...
class VenusChunkGenerator private constructor (
    ...
    companion object {
        val CODEC: Codec<VenusChunkGenerator> = RecordCodecBuilder.create<VenusChunkGenerator>(
            Function<RecordCodecBuilder.Instance<VenusChunkGenerator>, App<RecordCodecBuilder.Mu<VenusChunkGenerator>, VenusChunkGenerator>> { instance: RecordCodecBuilder.Instance<VenusChunkGenerator> ->
                instance.group(
                    BiomeSource.CODEC.fieldOf("biome_source").forGetter(VenusChunkGenerator::getBiomeSource),
                    Codec.LONG.fieldOf("seed").stable().forGetter(VenusChunkGenerator::genSeed),
                    ChunkGeneratorSettings.REGISTRY_CODEC.fieldOf("settings")
                        .forGetter { Supplier { it.settings() } },
                    RegistryLookupCodec.of(Registry.BIOME_KEY).forGetter(VenusChunkGenerator::biomeRegistry)
                )
                    .apply(
                        instance,
