...
class MarsChunkGenerator private constructor (
    ...
    companion object {
        val CODEC: Codec<MarsChunkGenerator> = RecordCodecBuilder.create<MarsChunkGenerator>(
            Function<RecordCodecBuilder.Instance<MarsChunkGenerator>, App<RecordCodecBuilder.Mu<MarsChunkGenerator>, MarsChunkGenerator>> { instance: RecordCodecBuilder.Instance<MarsChunkGenerator> ->
                instance.group(
                    BiomeSource.CODEC.fieldOf("biome_source").forGetter(MarsChunkGenerator::getBiomeSource),
                    Codec.LONG.fieldOf("seed").stable().forGetter(MarsChunkGenerator::genSeed),
                    ChunkGeneratorSettings.REGISTRY_CODEC.fieldOf("settings")
                        .forGetter { Supplier { it.settings() } },
                    RegistryLookupCodec.of(Registry.BIOME_KEY).forGetter(MarsChunkGenerator::biomeRegistry)
                )
                    .apply(
                        instance,
